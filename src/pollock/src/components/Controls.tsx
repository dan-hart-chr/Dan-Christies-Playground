...
export default function Controls({
  ...
  return (
    <>
      {/* ===== MOBILE: all 4 buttons in one centered row ===== */}
      <div className="absolute bottom-[155px] left-1/2 z-30 flex -translate-x-1/2 gap-[7px] md:hidden">
        <button
          className={`${btn} flex size-[48px] shrink-0 items-center justify-center rounded-[24px] bg-[rgba(244,244,244,0.8)]`}
        ...
        <button
          className={`${btn} flex shrink-0 items-center rounded-[100px] bg-[rgba(244,244,244,0.8)] p-4`}
      ...
      <div className="hidden md:block">
        <button
          className={`${btn} absolute bottom-[120px] left-[48px] z-30 flex size-[48px] items-center justify-center rounded-[24px] bg-[rgba(244,244,244,0.7)] backdrop-blur-[20px]`}
          aria-label="Information"
          onClick={() => onOpenPanel('info')}
          data-analytics="infoButton"
        >
        ...
        <button
          className={`${btn} absolute bottom-[120px] right-[48px] z-30 flex items-center rounded-[100px] bg-[rgba(244,244,244,0.7)] p-4 backdrop-blur-[20px]`}
          aria-label="Toggle sound"
          onClick={onMuteToggle}
          data-muted={`${muted ? 'true' : 'false'}`}
          data-analytics="muteButton"          
