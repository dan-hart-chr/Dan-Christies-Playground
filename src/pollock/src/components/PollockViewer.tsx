...
export default function PollockViewer() {
  ...
  return (
    <div ref={containerRef} className="relative" style={{ height: '500vh' }}>
      {/* Sticky viewport */}
      <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden bg-white text-[#222]">
        {/* The painting */}
        <img
          ref={imageRef}
          src={pollockImage}
        ...
        <div
          className={`pointer-events-none absolute inset-0 z-[45] bg-white transition-opacity duration-1000 ease-out ${
