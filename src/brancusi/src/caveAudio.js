  ...
  return {
    async start() {
      ...
      try {
        ...
        convolver.buffer = generateCaveImpulse(ctx, 4.2, 3.5);
        ...
        console.warn("Cave audio failed to initialise:", err);
      }
    },

    /** Start the spoken quotes layer (call after entrance animations complete). */
    startQuotes() {
...
function generateCaveImpulse(ctx, duration = 4.2, decay = 3.5) {
